...
var cubes = [
    translate(0, 0, 1),
    translate(camAtx+getRand(-10,10), 0, getRand(-10, -30)),
    translate(camAtx+getRand(-10,10), 0, getRand(-10, -30)),
    translate(camAtx+getRand(-10,10), 0, getRand(-10, -30)),
    translate(camAtx+getRand(-10,10), 0, getRand(-10, -30)),
    translate(camAtx+getRand(-10,10), 0, getRand(-10, -30)),
    ...
    for(var index = 0; index < cubes.length; index++){
        ...
        if(index == 0){        
            ...
            if(cubes[index][2][3] >= 1){
               cubes[index] = translate(camAtx+getRand(-5,5), 0, getRand(-10, -20))
            }else{
               cubes[index] = mult(cubes[index], translate(0,0,.01));
            }
            viewMatrix = mult(modelViewMatrix, cubes[index]);
            viewMatrix = mult(scale(.05,.05,.05),viewMatrix);
            if(cubes[index][0][3] +1 >= camAtx &&  cubes[index][0][3] -1 <= camAtx && cubes[index][2][3]+ 1 >=1 && cubes[index][2][3]-1 <=1){
                console.log('aaaaa!');
